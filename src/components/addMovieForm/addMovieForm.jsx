    ...
    return (
      <div className="add-movie-form">
        ...
        <div className="add-movie-form__fields">
          ...
          <input id="release" name="date" type="text" value={movie.date} onChange={this.changeField} />
          <div className={`add-movie-form__fields-validation ${validationError.date ? '' : 'hidden'}`}>Please enter correct release date in format yyyy-mm-dd</div>
        </div>

        <div className="add-movie-form__fields">
          <label className="add-movie-form__label" htmlFor="image">Image URL</label>
          <input id="image" name="path" type="text" value={movie.path} onChange={this.changeField} />
          <div className={`add-movie-form__fields-validation ${validationError.path ? '' : 'hidden'}`}>Please enter movie image address</div>
        </div>
